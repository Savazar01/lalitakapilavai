...
export const ADMIN_NAV_ITEMS: NavItemDef[] = [
  ...
  { id: "categories", defaultLabel: "Categories & Taxonomies", href: "/admin/categories", icon: FolderTree },
  { id: "artworks", defaultLabel: "Catalog & Assets", href: "/admin/artworks", icon: Palette },
  { id: "catalogs", defaultLabel: "Digital e-Catalogs", href: "/admin/catalogs", icon: Library },
  { id: "events", defaultLabel: "Events & Showcases", href: "/admin/events", icon: Calendar },
  { id: "leads", defaultLabel: "CRM Leads & Tracking", href: "/admin/leads", icon: Users },
