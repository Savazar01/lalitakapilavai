    ...
    const updated = await prisma.$transaction(async (tx) => {
      const ev = await tx.event.update({
        ...
        data: {
          ...
          galleryDisplayMode: galleryDisplayMode !== undefined ? galleryDisplayMode : undefined,
          galleryAutoplayTimer: galleryAutoplayTimer !== undefined ? parseInt(galleryAutoplayTimer, 10) : undefined,
          brochurePdfUrl: brochurePdfUrl !== undefined ? brochurePdfUrl : undefined,
          brochureTitle: brochureTitle !== undefined ? brochureTitle : undefined,
          brochureDownloadable: brochureDownloadable !== undefined ? !!brochureDownloadable : undefined,
