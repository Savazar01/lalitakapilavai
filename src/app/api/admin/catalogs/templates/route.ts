...
const DEFAULT_TEMPLATES = [
  {
    ...
    hasFooter: true,
    footerHtml: "<p>© SavazAI Atelier • Traditional Indian Classical Monograph</p>",
  ...
  },
  {
    ...
    hasFooter: true,
    footerHtml: "<p>Page Editorial • Curated by the SavazAI Atelier</p>",
  ...
  },
  {
    ...
    headerHtml: null,
    hasFooter: true,
    footerHtml: "<p>Archival Monograph • SavazAI Atelier • Sacred Art Archive</p>",
    verticalSpineMode: "NONE",
    verticalSpineWidth: "25%",
    verticalSpineHtml: null,
  ...
  },
  {
    ...
    hasFooter: true,
    footerHtml: "<p>Curated by SavazAI Atelier • Sacred Art Collection</p>",
    verticalSpineMode: "NONE",
    verticalSpineWidth: "25%",
    verticalSpineHtml: null,
    frameStyle: "gold-fillet",
  ...
  },
  {
    ...
    hasFooter: true,
    footerHtml: "<p>Published by SavazAI Atelier • Sacred Art &amp; Heritage</p>",
    verticalSpineMode: "LEFT",
    verticalSpineWidth: "22%",
    verticalSpineHtml: "<div style='text-align:center;'><p style='font-family:serif;font-size:13px;letter-spacing:0.2em;text-transform:uppercase;'><strong>SAVAZAI ATELIER</strong><br/><span style='font-size:10px;color:#D4AF37;'>SACRED ART ARCHIVE</span></p></div>",
    ...
    segments: [
      ...
      },
      {
        ...
        contentHtml: "<p style='text-align:center;font-size:12px;font-family:monospace;'>CURATED BY SAVAZAI ATELIER • ATELIER MONOGRAPH SERIES</p>",
      },
    ],
  },
];
...
const DEFAULT_PAGE_SECTION_TEMPLATES = [
  {
    ...
    verticalSpineMode: "LEFT",
    verticalSpineWidth: "25%",
    verticalSpineHtml: "<div style='text-align:center;'><p style='font-family:serif;font-size:14px;letter-spacing:0.15em;text-transform:uppercase;'><strong>ATELIER BIO</strong><br/><span style='font-size:11px;color:#D4AF37;'>SAVAZAI ATELIER</span></p><p style='font-size:12px;margin-top:8px;'>Exponent of Thanjavur 22k gold leaf iconography and classical South Indian devotional music.</p></div>",
    frameStyle: "gold-fillet",
    backgroundType: "COLOR",
    backgroundColor: "#FAF7F2",
    backgroundPattern: "lotus-jaali",
  ...
  },
  {
    ...
    hasFooter: true,
    footerHtml: "<p>© SavazAI Atelier • Sacred Art Archive</p>",
    verticalSpineMode: "NONE",
    verticalSpineWidth: "25%",
    verticalSpineHtml: null,
    frameStyle: "double-fillet",
  ...
  },
  {
    ...
    segments: [
      ...
      },
      {
        ...
        colSpan: 1,
        title: "Atelier Note",
        contentHtml: "<h4>Handcrafted in Chennai</h4><p>Created exclusively by Master Artist over 480 hours of meticulous relief work.</p>",
      },
    ],
  },
  {
    ...
    hasFooter: true,
    footerHtml: "<p>Traditional South Indian Sacred Iconography • SavazAI Atelier</p>",
    verticalSpineMode: "NONE",
    verticalSpineWidth: "25%",
    verticalSpineHtml: null,
    frameStyle: "silk-border",
