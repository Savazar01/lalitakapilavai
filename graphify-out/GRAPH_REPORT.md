...
## Corpus Check
- 209 files · ~220,647 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1335 nodes · 3155 edges · 101 communities (82 shown, 19 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `832671c3`
...
Cohesion: 0.22
Nodes (11): CustomDividerNode, DIVIDER_COLORS, DividerNodeAttributes, STYLES, THICKNESSES, WIDTHS, CustomImageNode, TextStyleMark (+3 more)

### Community 1 - "Community 1"
Cohesion: 0.13
Nodes (19): CatalogMatrixStudioProps, categoryBadges, categoryIcons, MilestoneCard(), TimelineBlockProps, TimelineMilestone, PageMatrixStudioProps, TimelineInspectorProps (+11 more)
...
Cohesion: 0.11
Nodes (19): SectionData, PageMatrixConfig, SectionData, BackgroundPattern, getPatternById(), getPatternStyle(), CatalogPrintButton(), CatalogPrintButtonProps (+11 more)
...
Cohesion: 0.09
Nodes (28): ModernDateTimePicker(), ModernDateTimePickerProps, MONTH_NAMES, SHORT_DAYS, formatCurrency(), formatLocalizedDateTime(), getOrdinalSuffix(), SupportedCurrency (+20 more)

### Community 8 - "Community 8"
Cohesion: 0.18
Nodes (6): metadata, metadata, Footer(), FooterConfig, LegalLinkItem, SocialLinkItem

### Community 9 - "Community 9"
Cohesion: 0.06
Nodes (40): 1. Artist Profile & Domain Context, 1. Platform Vision & Multi-Tenant Atelier Architecture, 2. Technology Stack & Architectural Standards, 2. Technology Stack & Modern Architectural Standards, 3. Core Operational Rule: Local-First Validation Before Deployment, 3. Universal Autonomous Agent Lifecycle & Quality Gates, 4. Living Document Governance Invariant, 4. Single-Folder Local 'DevPlans' Archiving Rule (+32 more)
...
Cohesion: 0.17
Nodes (13): DashboardLayoutManager(), DashboardWidgetData, iconRegistry, ArtCategoryItem, LeadItem, statusColors, authClient, Card (+5 more)
...
Cohesion: 0.13
Nodes (23): ArtworkBulkImportModal(), ArtworkBulkImportModalProps, ImportAuditItem, ImportAuditResult, MediaVaultDialogProps, MediaVaultItem, CATEGORY_OPTIONS, COMMON_TIMEZONES (+15 more)

### Community 33 - "Community 33"
Cohesion: 0.10
Nodes (26): CatalogBackgroundConfig, CatalogBackgroundControl(), CatalogBackgroundControlProps, HERITAGE_COLOR_PRESETS, reconcileMatrixCells(), CatalogSinglePlateEditor(), CatalogSinglePlateEditorProps, EditorialModeSwitcher() (+18 more)
...
Cohesion: 0.18
Nodes (20): AiAssistantModalProps, DynamicFormBlockProps, DynamicFormConfig, FIELD_TYPE_LABELS, FormBlockData, FormBlockInspectorProps, HeroBlockInspectorProps, MediaGalleryInspectorProps (+12 more)
...
Cohesion: 0.06
Nodes (42): MailConfigStudio(), ADMIN_NAV_ITEMS, NavItemDef, Sidebar(), SidebarProps, ALLOWED_TOKENS, AllowedToken, DynamicThemeProvider() (+34 more)
...
Cohesion: 0.10
Nodes (25): HeroShowcaseBlock(), PdfViewerBlock(), PdfViewerBlockProps, columnPresets, PageData, SortableSection(), SubSectionData, VisualPageBuilderProps (+17 more)

### Community 45 - "Community 45"
Cohesion: 0.12
Nodes (22): FormFieldConfig, HeroArchetype, HotspotPin, HeroBlockData, getCatalogDimensions(), getColorSaturation(), getContrastTypographyClasses(), BlogGridEmbed() (+14 more)
...
Cohesion: 0.08
Nodes (30): ArtworkPlacardSheet(), ArtworkPlacardSheetProps, CARD_BG_SWATCHES, DEFAULT_PLACARD_STYLING, EditablePlacardItem, HEADER_COLOR_SWATCHES, PlacardArtwork, TEXT_COLOR_SWATCHES (+22 more)
...
Cohesion: 0.06
Nodes (51): geistMono, geistSans, generateMetadata(), metadata, POST(), ThemeProvider(), getCellValue(), parseBoolean() (+43 more)
...
Cohesion: 0.15
Nodes (13): ArtworksAdminPage(), AlternatingTimelineList(), TimelineBlock(), MediaGalleryInspector(), artisticBorderPresets, availableIcons, colorPresets, fontFamilies (+5 more)
...
Cohesion: 0.07
Nodes (35): ArtworkMetadata, ArtworkPlacard(), ExhibitionWallBlock, getItemHref(), InteractiveDepthCard, ItemLinkWrapper(), KenBurnsCanvas, MediaGalleryBlock() (+27 more)
...
Cohesion: 0.25
Nodes (14): CatalogMatrixStudio(), PageMatrixStudio(), BackgroundStyleConfig, computeRelativeLuminance(), ContainerThemeScope, getPerceivedLuminance(), isLightColor(), NAMED_COLORS (+6 more)
...
Cohesion: 0.29
Nodes (9): AiAssistantModal(), CatalogTemplateItem, COLOR_PRESETS, FONT_FAMILIES, FONT_SIZES, BlogPostItem, TabsContent, TabsList (+1 more)
...
Cohesion: 0.13
Nodes (5): DiscoveredFormCategory, DiscoveredFormItem, fetchThumbnailBuffer(), GET(), globalForPrisma

### Community 94 - "Community 94"
Cohesion: 0.33
Nodes (4): BLEND_MODES, FloatingLayerAttributes, FloatingLayerNode, PopoverContent
...
Cohesion: 0.14
Nodes (15): EmailTiptapEditor(), EmailTiptapEditorProps, AVAILABLE_TOKENS, EmailLog, EmailTemplate, Pagination, HeroShowcaseBlockProps, ArtCanvasViewerProps (+7 more)
...
## Knowledge Gaps
- **507 isolated node(s):** `docker-entrypoint.sh script`, `eslintConfig`, `nextConfig`, `name`, `version` (+502 more)
...
- **Why does `Button` connect `Community 97` to `Community 0`, `Community 4`, `Community 7`, `Community 21`, `Community 31`, `Community 32`, `Community 33`, `Community 36`, `Community 39`, `Community 43`, `Community 44`, `Community 48`, `Community 50`, `Community 51`, `Community 53`, `Community 56`, `Community 57`, `Community 86`, `Community 87`, `Community 88`, `Community 90`, `Community 94`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 53` to `Community 0`, `Community 1`, `Community 4`, `Community 7`, `Community 21`, `Community 32`, `Community 33`, `Community 36`, `Community 39`, `Community 43`, `Community 44`, `Community 45`, `Community 48`, `Community 50`, `Community 56`, `Community 59`, `Community 69`, `Community 79`, `Community 85`, `Community 87`, `Community 90`, `Community 94`, `Community 97`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `Badge()` connect `Community 97` to `Community 32`, `Community 33`, `Community 1`, `Community 36`, `Community 69`, `Community 7`, `Community 8`, `Community 39`, `Community 43`, `Community 44`, `Community 48`, `Community 50`, `Community 51`, `Community 21`, `Community 53`, `Community 87`, `Community 56`, `Community 88`?**
